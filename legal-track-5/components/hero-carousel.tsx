...
import { ChevronLeft, ChevronRight, Scale, FileText, BookOpen, HeadphonesIcon } from "lucide-react"
...
const slides = [
  {
    ...
    buttonLink: "/predict",
    icon: <Scale className="h-24 w-24 text-white/20" />,
    shapes: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-20 w-64 h-64 rounded-full bg-white/5"></div>
        <div className="absolute bottom-10 right-40 w-40 h-40 rounded-full bg-white/5"></div>
        <div className="absolute top-40 left-10 w-20 h-80 rounded-full bg-white/5"></div>
      </div>
    ),
  },
  {
    ...
    buttonLink: "/file-fir",
    icon: <FileText className="h-24 w-24 text-white/20" />,
    shapes: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 right-40 w-40 h-40 rounded-lg rotate-45 bg-white/5"></div>
        <div className="absolute bottom-20 right-20 w-60 h-60 rounded-lg rotate-12 bg-white/5"></div>
        <div className="absolute top-40 left-20 w-32 h-32 rounded-lg rotate-45 bg-white/5"></div>
      </div>
    ),
  },
  {
    ...
    buttonLink: "/handbook",
    icon: <BookOpen className="h-24 w-24 text-white/20" />,
    shapes: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-30 w-80 h-20 rounded-full bg-white/5"></div>
        <div className="absolute bottom-40 right-20 w-40 h-40 rounded-full bg-white/5"></div>
        <div className="absolute top-20 left-20 w-60 h-60 rounded-full bg-white/5"></div>
      </div>
    ),
  },
  {
    ...
    buttonLink: "/support",
    icon: <HeadphonesIcon className="h-24 w-24 text-white/20" />,
    shapes: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 right-20 w-32 h-32 rounded-full bg-white/5"></div>
        <div className="absolute bottom-20 right-40 w-64 h-64 rounded-full bg-white/5"></div>
        <div className="absolute top-30 left-10 w-40 h-40 rounded-full bg-white/5"></div>
      </div>
    ),
  },
]
          ...
          <div className="relative z-20 h-full container mx-auto flex items-center">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="hidden md:flex justify-center items-center relative h-[350px]">
                <div className="absolute right-0 bottom-0 opacity-30">{slide.icon}</div>
